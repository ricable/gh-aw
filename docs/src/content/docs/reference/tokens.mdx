...
## GitHub Tokens and GitHub Actions Secrets Reference

### `COPILOT_GITHUB_TOKEN`

If using the Copilot CLI, you need a GitHub Personal Access Token (PAT) with the `copilot-requests` scope to authenticate Copilot CLI.
